...
var debug, debugSugar, Metalsmith, path, timer;
...
function buildSugar(smith) {
    ...
    sugar.build = (callback) => {
        ...
        callback = callback || ((err) => {
            ...
            debug("metalsmith-timer")("build complete");
        });
    ...
    sugar.use = function (middleware) {
        ...
        if (typeof middleware === "string") {
            ...
            debugSugar("Using middleware function: %s", middleware.name);
        ...
        smith.use(middleware)
            .use(timer(`Middleware completed: ${name}`));
